...
module.exports.getProfile = async zip => {
  ...
  await jimp
    .resize(150, 150)
    .writeAsync(withOutputPath(profile, './src/images/avatar.png'))
  ...
  if (!profileRemoteContent) {
    ...
    profile.bio = profileRemoteDom
      ...
      .replace(
        ` Every day, ${profile.authorName} and thousands of other voices read, write, and share important stories on Medium.`,
        ''
      )
  }
